" VIM port of the Espresso tutti colori theme
...
highlight Comment                   guifg=#999999 guibg=#eeeeee
gui=italic
...
highlight Statement                 guifg=#2f6f9f guibg=#f4faff
gui=NONE
highlight Type                      guifg=#699d36 guibg=NONE
gui=NONE
highlight Title                     guifg=#000000 guibg=NONE
gui=NONE
highlight Underlined                guifg=#2f4f6f guibg=NONE
gui=underline
...
" Python colors
highlight pythonInclude                 guifg=#2f6f9f guibg=#f4faff
gui=NONE
